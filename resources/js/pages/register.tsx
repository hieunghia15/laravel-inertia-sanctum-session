        ...
        try {
            ...
            if (err instanceof ValidationError) {
                ...
                err.inner.forEach((error) => {
                    if (error.path && !validationErrors[error.path as keyof RegisterFormData]) {
            ...
            <div className="flex min-h-screen flex-col items-center justify-center bg-zinc-50 px-4 py-12 text-zinc-900 sm:px-6 lg:px-8 dark:bg-zinc-950 dark:text-zinc-100">
                <div className="w-full max-w-md">
                    ...
                    <div className="text-center">
                        ...
                        <h1 className="mt-4 text-2xl font-semibold tracking-tight text-zinc-900 dark:text-zinc-50">Create an account</h1>
                        <p className="mt-1.5 text-sm text-zinc-600 dark:text-zinc-400">Enter your details below to register</p>
                    </div>
